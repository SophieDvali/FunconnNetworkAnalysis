...
#I need the number of edges between S I and M
...
# I think I am going to randomly reshuffle the SIM assignments
...
for i in np.arange(1000):
    random.shuffle(neuronlist_rand)
    sensory_rand = neuronlist_rand[0:70]
    inter_rand = neuronlist_rand[70:142]
    motor_rand = neuronlist_rand[142:188]
    ...
    for edg in all_edges:
        ...
        if source_neuron in sensory_rand:
            if target_neuron in inter_rand:
                S_to_I_rand += 1
                S_to_all_rand += 1

            elif target_neuron in motor_rand:
                S_to_M_rand += 1
                S_to_all_rand += 1

            elif target_neuron in sensory_rand:
                S_to_S_rand += 1
                S_to_all_rand += 1

        elif source_neuron in inter_rand:
            if target_neuron in motor_rand:
                I_to_M_rand += 1
                I_to_all_rand += 1

            elif target_neuron in inter_rand:
                I_to_I_rand += 1
                I_to_all_rand += 1
        ...
        elif source_neuron in motor_rand:
            if target_neuron in sensory_rand:
                M_to_S_rand += 1
                M_to_all_rand += 1
...
pval_log_SM = stats.ttest_ind(log_IM, np.array(logs_SM), alternative = "two-sided").pvalue
...
plt.tight_layout()
plt.savefig("/Users/sophiedvali/Documents/University/Research/NetworkAnalysis/SMBthings/Log_violinplot_SIM.pdf", dpi=300, bbox_inches="tight")
plt.savefig(
        "/Users/sophiedvali/Documents/University/Research/NetworkAnalysis/ForFigures/Fig6/Log_violinplot_SIM.pdf",
...
plt.yticks([-1.5,-1,-0.5,0,0.5,1,1.5], [-1.5,-1,-0.5,0,0.5,1,1.5],fontsize = 15 )
plt.tight_layout()
plt.savefig("/Users/sophiedvali/Documents/University/Research/NetworkAnalysis/SMBthings/Frac_violinplot_SIM.pdf", dpi=300, bbox_inches="tight")
plt.savefig(
        "/Users/sophiedvali/Documents/University/Research/NetworkAnalysis/ForFigures/Fig6/Frac_violinplot_SIM.pdf",
        dpi=300, bbox_inches="tight")
plt.show()
...
plt.text(0.92, 1.35, "**", fontsize = 25)
plt.text(1.94, 1.35, "*", fontsize = 25)
...
plt.ylim(-1.7, 1.7)
plt.tight_layout()
plt.savefig("/Users/sophiedvali/Documents/University/Research/NetworkAnalysis/SMBthings/Frac_violinplot_SIM_aconn.pdf", dpi=300, bbox_inches="tight")
plt.savefig(
        "/Users/sophiedvali/Documents/University/Research/NetworkAnalysis/ForFigures/Fig6/Frac_violinplot_SIM_aconn.eps",
...
plt.yticks([-1.5,-1,-0.5,0,0.5,1,1.5], [-1.5,-1,-0.5,0,0.5,1,1.5],fontsize = 15 )
plt.tight_layout()
plt.savefig("/Users/sophiedvali/Documents/University/Research/NetworkAnalysis/SMBthings/Log_violinplot_SIM_aconn.pdf", dpi=300, bbox_inches="tight")
plt.savefig(
        "/Users/sophiedvali/Documents/University/Research/NetworkAnalysis/ForFigures/Fig6/Log_violinplot_SIM_aconn.eps",
        dpi=300, bbox_inches="tight", format ="eps")
plt.show()
